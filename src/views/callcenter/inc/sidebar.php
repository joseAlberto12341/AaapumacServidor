...
<nav class="sidebar-modern" id="sidebar">
    ...
    <div class="sidebar-header">
        <div class="sidebar-brand">
            <a href="/Aaapumac/" class="brand-logo-full">
                <img src="/Aaapumac/src/views/assets/img/logoAaa.png" alt="AAAPUMAC"
    ...
    <div class="sidebar-menu">
        <ul class="nav-menu">
            ...
            <!-- Avisos -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/callcenter/modals">
            ...
            <!-- convenios -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/callcenter/convenio">
                    <div class="nav-icon gradient-purple">
