        ...
        <div class="card-body">
          ...
          <form method="post" id="trabajos" enctype="multipart/form-data" action="/Aaapumac/administrativo/editJob">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Contacto empresa</label>
                  <div class="col-sm-9">
                    <input type="email" name="ContactoEmpresa" id="ContactoEmpresa" class="form-control"
                      value="<?php echo $answer['data']['job']->getContactoEmpresa(); ?>" placeholder="Contacto empresa" />
                  </div>
                </div>
              </div>
            </div>
