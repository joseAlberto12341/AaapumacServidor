...
<nav class="sidebar-modern" id="sidebar">
    ...
    <div class="sidebar-menu">
        <ul class="nav-menu">
            <!-- Inicio -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoComun/profile">
                    <div class="nav-icon">
            ...
            <!-- Jurídico -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoComun/serviJuri">
            ...
            <!-- Arancelario -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoComun/serviAran">
                    <div class="nav-icon gradient-purple">
            ...
            <!-- Avisos -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoComun/Avisos">
                    <div class="nav-icon gradient-purple">
            ...
            <!-- convenios -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoComun/convenio">
                    <div class="nav-icon gradient-purple">
