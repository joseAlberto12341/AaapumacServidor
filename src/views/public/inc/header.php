...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="/src/views/assets/img/favicon.ico" type="img/png" />
...
<body 
<?php if (isset($answer['scripts']) && $answer['scripts'] == 'admin')
    ...
    <main>
        <header class="header-three sticky-header">
            <!-- Header Menu  -->
            <?php if (isset($answer['scripts']) && $answer['scripts'] == 'prime')
